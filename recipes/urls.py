...
urlpatterns = [
    ...
    path('recipes/<slug:slug>/publish/',
         RecipePublishView.as_view(), name='recipe_publish'),
    path('recipes/<slug:slug>/unpublish/',
         RecipeUnpublishView.as_view(), name='recipe_unpublish'),
